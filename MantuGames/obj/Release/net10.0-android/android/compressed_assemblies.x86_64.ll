...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [136 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13521800; uint32_t buffer_offset
	}, ; 133: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22368, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13693320; uint32_t buffer_offset
	}, ; 134: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2281984, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13715688; uint32_t buffer_offset
	} ; 135: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15997672, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15997672 x i8] zeroinitializer, align 16

...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MantuGames.dll" comes first in this list. */
		"MantuGames.dll",
		"GoogleGson.dll",
		...
		"Xamarin.AndroidX.Room.Common.JVM.dll",
		"Xamarin.AndroidX.Room.Runtime.dll",
		"Xamarin.AndroidX.Room.Runtime.Android.dll",
		...
		"Xamarin.AndroidX.Sqlite.Android.dll",
		"Xamarin.AndroidX.Sqlite.Framework.dll",
		"Xamarin.AndroidX.Sqlite.Framework.Android.dll",

...
public class InternalAcknowledgePurchaseResponseListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.BillingClient.Api.InternalAcknowledgePurchaseResponseListener, Xamarin.Android.Google.BillingClient", InternalAcknowledgePurchaseResponseListener.class, __md_methods);
	}
	...
	public InternalAcknowledgePurchaseResponseListener ()
	{
		...
		if (getClass () == InternalAcknowledgePurchaseResponseListener.class) {
			mono.android.TypeManager.Activate ("Android.BillingClient.Api.InternalAcknowledgePurchaseResponseListener, Xamarin.Android.Google.BillingClient", "", this, new java.lang.Object[] {  });
		}
	}
